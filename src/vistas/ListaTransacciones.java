...
public class ListaTransacciones extends javax.swing.JFrame {
    ...
    public ListaTransacciones() {
        ...
        table1.addColumn("Codigo Transaccion");
        table1.addColumn("Fecha");
        table1.addColumn("Monto Total");
        jTable1.setModel(table1);
        consulta2= new ControladorVenta();
        lista = consulta2.ListarTransaccion(); 
        while(table1.getRowCount()>0) table1.removeRow(0);
        Object[] fila = new Object[6];
        for (int x=0;x<lista.size();x++){
            fila[0]=lista.get(x).getIdTransaccion();
            fila[1]=lista.get(x).getFecha();
            fila[2]="$"+lista.get(x).getMonto_total();
            table1.addRow(fila);
        }jTable1.updateUI();
    }
